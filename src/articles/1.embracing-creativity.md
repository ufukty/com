...
<video controls muted preload loop autoplay playsinline poster=".assets/routes.png">
  <source src=".assets/routes.webm" type="video/webm" />
  <source src=".assets/routes.mp4" type="video/mp4" />
</video>
